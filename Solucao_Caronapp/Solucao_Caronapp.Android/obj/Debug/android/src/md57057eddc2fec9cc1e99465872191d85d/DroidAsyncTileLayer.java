...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.GoogleMaps.Android.DroidAsyncTileLayer, Xamarin.Forms.GoogleMaps.Android, Version=2.2.1.2, Culture=neutral, PublicKeyToken=null", DroidAsyncTileLayer.class, __md_methods);
	}
	...
	public DroidAsyncTileLayer ()
	{
		...
		if (getClass () == DroidAsyncTileLayer.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.GoogleMaps.Android.DroidAsyncTileLayer, Xamarin.Forms.GoogleMaps.Android, Version=2.2.1.2, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
