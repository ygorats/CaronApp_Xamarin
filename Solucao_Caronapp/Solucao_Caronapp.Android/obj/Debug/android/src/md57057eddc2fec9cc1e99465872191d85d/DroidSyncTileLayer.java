...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.GoogleMaps.Android.DroidSyncTileLayer, Xamarin.Forms.GoogleMaps.Android, Version=2.2.1.2, Culture=neutral, PublicKeyToken=null", DroidSyncTileLayer.class, __md_methods);
	}
	...
	public DroidSyncTileLayer ()
	{
		...
		if (getClass () == DroidSyncTileLayer.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.GoogleMaps.Android.DroidSyncTileLayer, Xamarin.Forms.GoogleMaps.Android, Version=2.2.1.2, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
